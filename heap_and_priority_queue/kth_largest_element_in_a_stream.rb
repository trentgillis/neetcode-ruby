...
# Heap implementaion from https://github.com/florian/rb_heap 
# Using this because the included implementation from the algorithms gem has an inefficiency in its
# push method that will cause the submission to fail. The below is correctly optimized.
class Heap
